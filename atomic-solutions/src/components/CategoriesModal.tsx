        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
                    ...
                    <div key={sub.id} className="p-5 bg-[#0A192F]/60 rounded-3xl border border-[#233554] flex flex-col h-full shadow-lg">
                      ...
                      <div className="flex flex-col gap-2.5 mb-6 flex-1">
                        <div className="flex justify-between items-center p-3 bg-white/5 rounded-xl border border-white/5">
                          ...
                          <span className="text-sm font-black text-white">₹{labourMin}{labourMax > labourMin ? `-${labourMax}` : ''}</span>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-[#64FFDA]/5 rounded-xl border border-[#64FFDA]/20">
                          ...
                          <span className="text-sm font-black text-[#64FFDA]">₹{materialMin}{materialMax > materialMin ? `-${materialMax}` : ''}</span>
                        </div>
                      </div>
            ...
            <div className="p-8 border-t border-[#233554] bg-[#0A192F]/50 flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <button 
                onClick={() => window.open(formatWhatsAppLink(whatsapp, 'Hello Atomic Solutions, I need a custom quote for specialized work.'), '_blank')}
