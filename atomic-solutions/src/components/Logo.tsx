      ...
      >
        ...
        <div className="flex flex-col">
          <motion.span 
            ...
            style={{ 
              color: variant === 'light' ? '#ffffff' : '#001f3f', 
              fontFamily: 'Montserrat, sans-serif',
              textShadow: variant === 'light' ? '0 0 20px rgba(0, 255, 255, 0.2)' : 'none'
            }} 
          ...
          <motion.span 
            className={`${sizes[size].sub} font-bold tracking-[0.05em] leading-none mt-1 uppercase`} 
            style={{ color: variant === 'light' ? '#00e5ff' : '#008080' }}
