    ...
    <section id="services" className="py-24 bg-[#0A192F]">
        ...
        <div className="flex flex-col items-center mb-20">
          <div className="text-center mb-12">
            <motion.h2 
              ...
              className="text-4xl md:text-7xl font-black text-[#64FFDA] mb-6 uppercase tracking-tighter"
            >
              OUR EXPERTISE
            </motion.h2>
            <motion.p 
              ...
              className="text-[#8892B0] max-w-2xl mx-auto text-lg font-medium"
            >
              Atomic Solutions provides high-quality maintenance and construction services. Click on a service to see specialized sub-categories and dual pricing (Labour vs Material).
            </motion.p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[...services]
            ...
            <ServiceCard 
              ...
              onBook={(subName, type) => setBookingDetails({ serviceName: service.name, subName, type })}
              onNavigate={() => navigate(`/service/${service.id}`)}
            />
          ))}
        </div>
      </div>
      ...
      <CategoriesModal 
        ...
        onBook={(subName, type) => {
          ...
          setBookingDetails({ serviceName: selectedServiceForModal?.name || '', subName, type });
        }}
      />
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                    ...
                    {(labourMin > 0 || labourMax > 0) && (
                        <div className="flex items-center gap-4 bg-[#008080] p-5 rounded-2xl border border-white/20 flex-1 sm:flex-none sm:min-w-[200px] shadow-lg mb-2">
                        <div className="flex-1">
                        ...
                        <motion.button 
                          ...
                          className="w-10 h-10 bg-white/10 hover:bg-white text-[#008080] rounded-xl flex items-center justify-center transition-all"
                          title="Book Labour"
                        >
                    ...
                    {(materialMin > 0 || materialMax > 0) && (
                        <div className="flex items-center gap-4 bg-white/5 p-5 rounded-2xl border border-[#64FFDA]/20 flex-1 sm:flex-none sm:min-w-[220px] mb-2">
                        <div className="flex-1">
                        ...
                        <motion.button 
                          ...
                          className="w-10 h-10 bg-[#64FFDA] text-[#0A192F] rounded-xl flex items-center justify-center transition-all shadow-lg shadow-[#64FFDA]/20 hover:scale-105"
