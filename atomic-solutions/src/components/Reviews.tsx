...
const DEFAULT_REVIEWS = [
  {
    ...
    rating: 5,
    comment: 'Excellent service! Mustak and his team fixed our HVAC system in no time. Highly professional and polite.',
    date: 'Oct 2025',
    isApproved: true
  },
  {
...
export default function Reviews() {
  ...
  useEffect(() => {
    const unsub = dataService.subscribe('reviews', (data) => {
      const approvedReviews = (data as Review[]).filter(r => r.isApproved === true);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-20 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div>
              <h4 className="text-white text-2xl font-black uppercase tracking-tighter mb-2">Dream Royal Trust</h4>
