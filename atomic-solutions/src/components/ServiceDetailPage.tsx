                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {service.subCategories?.map((sub, idx) => (
                                <div 
                                    id={`sub-${sub.id}`}
                                    key={idx} 
                                    className="group bg-gray-50/50 hover:bg-white p-6 rounded-3xl border border-transparent hover:border-teal/20 transition-all"
                                >
                                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                        <div className="min-w-0 flex-1">
                                            <h4 className="text-lg font-black text-navy uppercase tracking-tight truncate">{sub.name}</h4>
                                        ...
                                        <div className="flex flex-wrap items-center gap-6 lg:gap-8">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <div className="text-lg font-black text-navy whitespace-nowrap">₹{sub.labourMin || sub.minPrice}<span className="text-gray-400">-{sub.labourMax || sub.maxPrice}</span></div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <div className="text-lg font-black text-navy whitespace-nowrap">₹{sub.materialMin || sub.minPrice}<span className="text-orange-200">-{sub.materialMax || sub.maxPrice}</span></div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex gap-2 w-full sm:w-auto">
                                                <button 
                                                    ...
                                                    className="flex-1 sm:flex-none h-11 px-4 rounded-xl bg-white border border-gray-100 text-navy hover:bg-gray-50 transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap"
                                                >
                                                    Labour
                                                </button>
                                                <button 
                                                    onClick={() => handleBook(sub.name, 'MATERIAL')}
                                                    className="flex-1 sm:flex-none h-11 px-6 rounded-xl bg-navy hover:bg-teal text-white flex items-center justify-center transition-all font-black text-[9px] uppercase tracking-widest whitespace-nowrap shadow-lg shadow-navy/5"
                                                >
                                                    Material
                                                </button>
                                            </div>
