...
let content = fs.readFileSync('src/components/CategoriesModal.tsx', 'utf-8');

// Update onBook prop type
...
fs.writeFileSync('src/components/CategoriesModal.tsx', content);
console.log('CategoriesModal.tsx updated');
