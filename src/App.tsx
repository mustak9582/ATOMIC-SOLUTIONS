      ...
      <AnimatePresence mode="wait">
        <Routes location={location}>
          ...
          <Route path="/login" element={
            user ? (
              activeRole === 'admin' ? <Navigate to="/admin" replace /> :
              activeRole === 'staff' ? <Navigate to="/professional" replace /> :
              <Navigate to="/my-account/bookings" replace />
            ) : <LoginPage />
          } />
          
          <Route path="/dashboard" element={user ? <UserDashboard /> : <Navigate to="/login" replace />} />
          <Route path="/professional" element={user && (isStaff || activeRole === 'staff') ? <StaffDashboard /> : <Navigate to="/login" replace />} />
