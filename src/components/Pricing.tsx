...
import { getLocalCustomServices, fetchServerServices, mergeServicesWithOverrides } from '../services/serviceStorage';
...
export default function ServicesSection() {
  ...
  useEffect(() => {
    ...
    const handleServicesUpdated = () => {
      setServices(current => mergeServicesWithOverrides(current, getLocalCustomServices()));
    };
    ...
    <section id="services" className="py-20 sm:py-28 bg-slate-app">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            href={`https://wa.me/${whatsapp.replace(/\D/g, '')}?text=Hi Atomic HVAC Team, I want to discuss a custom service requirement.`}
            target="_blank"
