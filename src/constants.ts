...
export const CORE_SERVICES: Service[] = [
  {
    id: 'hvac',
    name: 'HVAC Solutions (AC & Ventilation)',
    category: 'Comfort',
    images: ['https://images.unsplash.com/photo-1599839619722-39751411883e?auto=format&fit=crop&q=80&w=800'],
    youtubeId: 'M7lc1UVf-VE',
    detailedDescription: '<p>Comprehensive climate control and ventilation solutions.</p>',
    staffCategory: 'AC Technician (HVAC)',
    subCategories: [
  ...
  },
  {
    ...
    staffCategory: 'Mason / Civil Worker',
    subCategories: [
  ...
  },
  {
    ...
    staffCategory: 'Interiors / False Ceiling',
    subCategories: [
  ...
  },
  {
    ...
    staffCategory: 'Tile & Marble Specialist',
    subCategories: [
  ...
  },
  {
    ...
    staffCategory: 'Door & Windows Technician',
    subCategories: [
  ...
  {
    id: 'carpentry',
    name: 'Woodwork & Furniture (Carpenter)',
    category: 'Interior',
    images: ['https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&q=80&w=800'],
    youtubeId: 'dQw4w9WgXcQ',
    detailedDescription: '<p>Custom furniture, modular kitchens, and expert cabinetry work.</p>',
    staffCategory: 'Carpenter',
    subCategories: [
      { id: 'carp-kitchen', name: 'Modular Kitchen (Full Setup)', minPrice: 85000, maxPrice: 250000, unit: 'Job' },
      { id: 'carp-wardrobe', name: 'Wardrobe & Cupboards', minPrice: 1200, maxPrice: 1800, unit: 'Sq. Ft' },
      { id: 'carp-repair', name: 'Furniture Repair & Polishing', minPrice: 500, maxPrice: 5000 },
      { id: 'carp-laminate', name: 'Sunmica & Laminate Fitting', minPrice: 40, maxPrice: 65, unit: 'Sq. Ft' },
    ]
  },
  {
    id: 'deep-cleaning',
    ...
    category: 'Utility',
    images: ['https://images.unsplash.com/photo-1581578731548-c64695ce6958?auto=format&fit=crop&q=80&w=800'],
    youtubeId: 'dQw4w9WgXcQ',
    detailedDescription: '<p>Professional deep cleaning for homes, offices, and tanks.</p>',
    staffCategory: 'General Maintenance',
    subCategories: [
      { id: 'clean-full-house', name: 'Full House Deep Cleaning', minPrice: 4500, maxPrice: 12000, unit: 'Flat' },
      { id: 'clean-bathroom', name: 'Bathroom Deep Cleaning', minPrice: 800, maxPrice: 1500, unit: 'Unit' },
      { id: 'clean-sofa', name: 'Sofa & Carpet Shampooing', minPrice: 500, maxPrice: 3500 },
      { id: 'clean-tank', name: 'Water Tank Cleaning', minPrice: 500, maxPrice: 1500 },
    ]
  },
  {
    id: 'home-planning',
    ...
    staffCategory: 'Architect / Planner',
    subCategories: [
...
export const FOUNDER_EMAIL = 'atomichvacsolution@gmail.com';
export const WHATSAPP_NUMBER = '919582268658';
export const PHONE_NUMBER = '+91 9582268658';
...
export const STAFF_CATEGORIES = [
  ...
  'Plumber',
  'Painter',
  'Door & Windows Technician',
  'Mason / Civil Worker',
  'Interiors / False Ceiling',
...
export const DEOGHAR_AREAS = [
  'Baidyanath Dham (Main Tower)',
  'Castairs Town',
  'Kunda',
  'Jasidih',
  'Rohini',
